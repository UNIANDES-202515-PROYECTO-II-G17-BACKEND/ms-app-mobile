...
const resources = {
  en: {
    translation: {
      ...
      visitRegisteredSuccess: 'Visit registered successfully.',
      errorRegisteringVisit: 'Error registering the visit',
      errorLoadingClients: 'Error loading client list',
      selectClient: 'Select client',
      enterContactName: 'Enter contact name',
      describeTechnicalFindings: 'Describe technical or clinical findings during the visit',
      describeProductSuggestions: 'Describe product suggestions or recommendations',
      close: 'Close',
    },
  },
  es: {
