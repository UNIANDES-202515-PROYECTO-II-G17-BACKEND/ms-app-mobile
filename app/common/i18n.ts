...
const resources = {
  en: {
    translation: {
      ...
      tapToRegisterDetails: 'Tap to register details',
      photosVideos: 'Photos and Videos',
      addPhotoVideo: 'Add Photo or Video',
      mediaPermissionDenied: 'Gallery access permissions are required',
      errorPickingMedia: 'Error selecting file',
      // Scheduled Deliveries screen
      scheduledDeliveries: 'Scheduled Deliveries',
      noDeliveries: 'No Scheduled Deliveries',
      noDeliveriesMessage: 'You don\'t have any pending deliveries',
      loadingDeliveries: 'Loading scheduled deliveries...',
      errorLoadingDeliveries: 'Error loading deliveries',
      dispatched: 'Dispatched',
      dispatchDate: 'Dispatch Date',
      warehouse: 'Warehouse',
      tapToViewDetails: 'Tap to view details',
      retry: 'Retry',
      viewYourDeliveries: 'View your scheduled deliveries',
      routeDate: 'Route Date',
      routeStatus: 'Route Status',
      invalidDateFormat: 'Invalid date format',
      useDateFormat: 'Please use the format YYYY-MM-DD (e.g., 2025-10-29)',
      selectDatePrompt: 'Enter a date to filter',
      selectDateMessage: 'Enter a date in YYYY-MM-DD format to view scheduled deliveries',
      route: 'Route',
      stop: 'Stop',
      delivery: 'Delivery',
      // New Order screen
      mustAddProduct: 'You must add at least one product to the order',
      invalidDateFormat2: 'Invalid date format. Use YYYY-MM-DD (e.g., 2025-10-30)',
      productsWithoutWarehouse: 'Some products do not have an assigned warehouse',
      mustSelectClient: 'You must select an institutional client',
      mustSelectSeller: 'You must select a seller',
      invalidProductValues: 'Some products have invalid values. Please check the information.',
  ...
  es: {
    translation: {
      ...
      tapToRegisterDetails: 'Toca para registrar detalles',
      photosVideos: 'Fotos y Videos',
      addPhotoVideo: 'Agregar Foto o Video',
      mediaPermissionDenied: 'Se necesitan permisos para acceder a la galería',
      errorPickingMedia: 'Error al seleccionar archivo',
      // Scheduled Deliveries screen
      ...
      useDateFormat: 'Por favor usa el formato YYYY-MM-DD (ej: 2025-10-29)',
      selectDatePrompt: 'Ingresa una fecha para filtrar',
      selectDateMessage: 'Ingresa una fecha en formato YYYY-MM-DD para consultar las entregas programadas',
      route: 'Ruta',
      stop: 'Parada',
      delivery: 'entrega',
      // New Order screen
      mustAddProduct: 'Debe agregar al menos un producto al pedido',
      invalidDateFormat2: 'Formato de fecha inválido. Use YYYY-MM-DD (ej: 2025-10-30)',
      productsWithoutWarehouse: 'Algunos productos no tienen bodega asignada',
      mustSelectClient: 'Debe seleccionar un cliente institucional',
      mustSelectSeller: 'Debe seleccionar un vendedor',
      invalidProductValues: 'Algunos productos tienen valores inválidos. Por favor verifica la información.',
